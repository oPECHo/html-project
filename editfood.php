...
$id_product=$_GET['id_product'];
    ...
    $sql = "SELECT * FROM tb_product where id_product='$id_product'";
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" method="POST" action="php_link.php" id="signup-form" enctype="multipart/form-data">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Your nameproduct">
						...
						<input class="input100" type="text" name="nameproduct" value ="<?php echo $obj['nameproduct'];?>">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Your number">
						...
						<input class="input100" type="text" name="number" value ="<?php echo $obj['number'];?>">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>
					...
					<div class="wrap-input100 validate-input m-b-23" >
						<img src="img/<?php echo $obj['image']; ?>" width="390px" height="390px">
					</div>
							
					<div class="wrap-input100 validate-input m-b-23" data-validate = "your price">
						<span class="label-input100">price</span>
						<input class="input100" type="text" name="price" value ="<?php echo $obj['price'];?>">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>			
					<div class="container-login100-form-btn">

						<input type="hidden" name="cmd" value="editfood" >
						<input type="hidden" name="id_product" value ="<?php echo $id_product; ?>" >	
					<input type="submit" class="btn btn-outline-info btn-lg btn-block" value="update food">
					</div>		
				</form>
			</div>
		</div>
