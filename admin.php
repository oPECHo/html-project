		...
		<div class="header-bottom">
			<div class="container">
				...
				<ul class="main-menu">
					...
					<li><a href="bill.php">Menu</a></li>
					<li><a href="food.php">Product</a></li>
					<li><a href="registerproduct.php">Insert product</a></li>
					<li><a href="mainadmin.php">Main</a></li>
				</ul>
			</div>
		</div>
	</header>
        ...
        <table class="table table-warning table-hover  ">
		 <thead class="thead-dark">
          ...
          <tbody>
			...
			?>
			<tr>
				<td><?php echo $obj['id_person'];?></td>
				<td><?php echo $obj['num_person'];?></td>
				<td><?php echo $obj['prefix'];?></td>
				...
				<td><a href="php_link.php?cmd=deluser&id_person=<?php echo $obj['id_person'];?>"
				onclick="return confirm('ต้องการลบใช่หรือไม่')">Delete</a></td>
				<td><a href="edituser.php?id_person=<?php echo $obj['id_person'];?>"
