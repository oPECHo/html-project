...
";
  ...
  <tr>
	...
	<td><a button class="btn btn-round btn-danger btn-xs " href="php_link.php?cmd=delbasket_detail&id_detail=<?php echo $obj1["id_detail"]; ?>">ลบสินค้า</button></a></td>
...
?>
  <tr> <td  colspan="6">
   <?php
  if($obj['status_basket'] == '0'){ ?>
         <center><a button class="btn btn-round btn-info btn-xs " href="php_link.php?id_basket1=<?php echo $obj["id_basket"]; ?>">ยืนยันการส่ง</button></a>
		 <a button  class="btn btn-round btn-success btn-xs disabled"  href="php_link.php?id_basket2=<?php echo $obj["id_basket"]; ?>">ส่งเรียบร้อย</button></a> 
		 <a button class="btn btn-round btn-secondary btn-xs " href="pdf.php?id_basket=<?php echo $obj["id_basket"]; ?>">ออกรายงาน</button></a> 
		 <a button class="btn btn-round btn-danger btn-xs " href="php_link.php?cmd=delbasket&id_basket=<?php echo $obj["id_basket"]; ?>">ยกเลิกการสั่ง</button></a> </center>
		
		 
  <?php  
 }else{?>
 <center><a button  class="btn btn-round btn-info btn-xs disabled"  href="php_link.php?id_basket1=<?php echo $obj["id_basket"]; ?>  ">ยืนยันการส่ง</button></a>
 <a button class="btn btn-round btn-success btn-xs " href="php_link.php?id_basket2=<?php echo $obj["id_basket"]; ?>">ส่งเรียบร้อย</button></a> 
 <a button class="btn btn-round btn-secondary btn-xs " href="pdf.php?id_basket=<?php echo $obj["id_basket"]; ?>">ออกรายงาน</button></a>
 <a button class="btn btn-round btn-danger btn-xs " href="php_link.php?cmd=delbasket&id_basket=<?php echo $obj["id_basket"]; ?>">ยกเลิกการสั่ง</button></a> </center>
